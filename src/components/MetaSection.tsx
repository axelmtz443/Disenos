    ...
    <div className="w-[420px] max-w-[90vw] bg-[#242526] rounded-xl shadow-[0_4px_12px_rgba(0,0,0,0.5)] border border-[#3e4042] overflow-hidden font-sans flex-shrink-0 self-start transition-all duration-300 relative">
      ...
      <div className="relative border-y border-[#3e4042] bg-[#18191a] pt-3 pb-4 px-3 overflow-hidden">
        <div className="flex transition-transform duration-500 ease-in-out" style={{ transform: `translateX(-${scrollIndex * (100 / visibleCards)}%)` }}>
          {cards.map((card, idx) => (
            <div key={idx} className="w-[270px] flex-shrink-0 mr-3 bg-[#242526] rounded-xl border border-[#3e4042] overflow-hidden shadow-md flex flex-col group">
        ...
        {scrollIndex > 0 && (
          <button onClick={slidePrev} className="absolute left-4 top-1/2 -translate-y-1/2 w-9 h-9 rounded-full bg-[#242526] border border-[#3e4042] shadow-[0_2px_8px_rgba(0,0,0,0.5)] flex items-center justify-center text-[#e4e6eb] hover:bg-[#3a3b3c] transition-colors z-10">
        ...
        {scrollIndex < maxIndex && (
          <button onClick={slideNext} className="absolute right-4 top-1/2 -translate-y-1/2 w-9 h-9 rounded-full bg-[#242526] border border-[#3e4042] shadow-[0_2px_8px_rgba(0,0,0,0.5)] flex items-center justify-center text-[#e4e6eb] hover:bg-[#3a3b3c] transition-colors z-10">
...
export default function MetaSection() {
  ...
  return (
    <section id="redes-sociales" className="min-h-screen bg-[#0e0f11] text-zinc-100 flex flex-col xl:flex-row items-stretch overflow-x-hidden font-sans selection:bg-[#0866ff] selection:text-white">
      ...
      <div className="w-full xl:w-2/3 flex flex-col justify-center py-16 xl:py-0 relative bg-[#0e0f11] overflow-x-hidden overflow-y-visible min-h-[60vh]">
        ...
        <button onClick={handlePrevAd} className="absolute left-4 md:left-8 top-1/2 -translate-y-1/2 w-14 h-14 rounded-full bg-[#242526]/80 backdrop-blur-md hover:bg-[#3a3b3c] border border-zinc-700 shadow-2xl flex items-center justify-center text-white transition-all transform hover:scale-105 active:scale-95 z-30">
        ...
        <button onClick={handleNextAd} className="absolute right-4 md:right-8 top-1/2 -translate-y-1/2 w-14 h-14 rounded-full bg-[#242526]/80 backdrop-blur-md hover:bg-[#3a3b3c] border border-zinc-700 shadow-2xl flex items-center justify-center text-white transition-all transform hover:scale-105 active:scale-95 z-30">
